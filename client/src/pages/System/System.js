...
import CancelAppointment from '../../components/System/CancelAppointment/CancelAppointment';
                ...
                <Router>
                    ...
                    <div className="system-router">
                        ...
                        <Switch>
                            ...
                            <Route path='/system/cancel-appoint-manage' component={(CancelAppointment)} />
                        </Switch> 
                    </div>
                </Router>
            </div>
