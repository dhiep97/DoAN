...
class DeleteSpecialtyModal extends Component {
    ...
    handleDelete = () => {
        this.props.deleteSpecialty(this.props.currentSpecialty.original.id)
    }
            ...
            <>
                ...
                >
                    ...
                    <div className="delete-modal-body">
                        <span>Bạn muốn chuyên khoa này</span>
                    </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(DeleteSpecialtyModal);