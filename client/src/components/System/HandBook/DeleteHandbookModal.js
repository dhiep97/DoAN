...
class DeleteHandbookModal extends Component {
    ...
    handleDelete = () => {
        this.props.deleteHandbook(this.props.currentHandbook.original.id)
    }
            ...
            <>
                ...
                >
                    ...
                    <div className="delete-modal-body">
                        <span>Bạn muốn xóa bài viết này</span>
                    </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(DeleteHandbookModal);